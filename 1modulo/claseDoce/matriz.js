...
function cargar(matriz, f, c, numAzar) {
    ...
    cadena= " ";
        for (col = 0; col < c; col++) {
            ...
            console.log(cadena=cadena + " [" + String(matriz[fil][col]) + "]");
        }
    } 
...
let f =3; //acá defino la cantidad de filas de la matriz
let c =4; // acá defino la cantidad de columnas de la matriz
